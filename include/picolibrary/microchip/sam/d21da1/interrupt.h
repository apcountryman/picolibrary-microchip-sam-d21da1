...
/**
 * \file
 * \brief picolibrary::Microchip::SAM::D21DA1::Interrupt interface.
 */

#ifndef PICOLIBRARY_MICROCHIP_SAM_D21DA1_INTERRUPT_H
#define PICOLIBRARY_MICROCHIP_SAM_D21DA1_INTERRUPT_H
